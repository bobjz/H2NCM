        ...
        for test_split in range(5):
            ...
            for i in range(len(list_params)):
                ...
                for val_split in range(3):
                    ...
                    #print(total_params)
                    train_h,val_h,test_h=train_model(model,alpha,beta,train,val,test,epochs=50,lr=1*1e-2,device=device)
            ...
            train_h,val_h,test_h=train_model(model,alpha,beta,train,val,test,epochs=50,lr=1*1e-2,\
